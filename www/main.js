...
var map = {
	"./pages/adopter/browsing/browsing.module": [
		"./src/app/pages/adopter/browsing/browsing.module.ts",
		"pages-adopter-browsing-browsing-module"
	],
	"./pages/adopter/filter/filter.module": [
		"./src/app/pages/adopter/filter/filter.module.ts",
		"pages-adopter-filter-filter-module"
	],
	"./pages/adopter/likes/likes.module": [
	...
	"./pages/shelter/add-animal/add-animal.module": [
		"./src/app/pages/shelter/add-animal/add-animal.module.ts",
		"pages-shelter-add-animal-add-animal-module"
	],
	"./pages/shelter/edit-animal/edit-animal.module": [
		"./src/app/pages/shelter/edit-animal/edit-animal.module.ts",
		"pages-shelter-edit-animal-edit-animal-module"
	],
	"./pages/shelter/manage-animals/manage-animals.module": [
		"./src/app/pages/shelter/manage-animals/manage-animals.module.ts",
		"pages-shelter-manage-animals-manage-animals-module"
	],
	"./pages/shelter/registration/registration.module": [
		"./src/app/pages/shelter/registration/registration.module.ts",
		"pages-shelter-registration-registration-module"
	],
	"./pages/shelter/signup/signup.module": [
		"./src/app/pages/shelter/signup/signup.module.ts",
		"pages-shelter-signup-signup-module"
	],
	"./pages/user-selection/user-selection.module": [
...
module.exports = __webpack_require__(/*! /Users/hannahestes/Desktop/Dev/shelter-connect/shelter-connect/src/main.ts */"./src/main.ts");
